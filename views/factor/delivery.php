<div id="deliveryModal" class="  hidden fixed inset-0 bg-gray-900/75 flex justify-center items-center">
    <div class="min-full w-1/2 bg-white p-4 rounded  ">
        ...
        <div class="modal-body">
            ...
            <p class="text-xs text-white m-1 p-2 bg-blue-500 text-center rounded mt-2">شماره فاکتور <span class=" text-xs p-3 text-center font-semibold" id="display_billNumber"></span></p>

            <form action="" id="deliveryForm" onsubmit="saveDelivery(event)" class="mt-5">
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div>
                        ...
                        <select required id="deliveryType" name="deliveryType" class="w-full border border-gray-300 p-1  px-2 rounded">
                            <option value="">انتخاب بکنید</option>
                    ...
                    <div>
                        ...
                        <select  id="deliverycost" name="deliverycost" class="w-full border border-gray-300 p-1 px-2 rounded">
                        ...
                        <input type="number" placeholder="هزینه دیگر را وارد کنید" name="deliverycostother" id="deliverycostother" class="w-full border  border-gray-300 p-1 px-2 rounded mt-2" style="display:none;">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold mb-2" for="courier">پیک</label>
                        <select id="courier" name="courier" class="w-full border  border-gray-300 p-1 rounded">
                            <option value="">انتخاب کنید</option>
                            <option value="آقای عباسی">آقای عباسی</option>
                            <option value="آقای امیر دوست">آقای امیر دوست</option>
                            <option value="other">سایر</option>
                        </select>

                        <input type="text" placeholder="نام پیک را وارد کنید" name="courier" id="courierother" class="w-full border border-gray-300 p-1 rounded mt-2 px-2 " style="display:none;">
                    </div>
                </div>

                <div>
                    <label class="block text-sm font-semibold mt-2" for="address">آدرس مقصد:</label>
                    <input type="text" id="address" name="address" class="w-full border border-gray-300 p-2 rounded" placeholder="آدرس ارسال را وارد کنید...">
                </div>

                <div class="grid grid-cols-3 gap-4">
                    <div class="mt-4">
                        <p><strong>مبلغ کل</strong>
                            <span class="text-gray-600 text-xs p-1 text-center font-semibold" id="display_total"></span>
                        </p>
                    ...
                    <div class="mt-4">
                        <p><strong>مبلغ پرداخت شده</strong>
                            ...
                            <span class="text-gray-600 text-xs p-1 text-center font-semibold" id="display_paid"></span>
                        </p>
                    </div>
                    <div class="mt-4">
                        <p><strong>مبلغ باقی مانده</strong>
                            <span class="text-gray-600 text-xs p-1 text-center font-semibold " id="display_remaining">
                            </span>
                        </p>
                        <input type="number" placeholder="مبلغ باقی مانده واقعی " name="peymentother" id="peymentother" class="w-full border border-gray-300 p-1 rounded mt-2 text-sm px-2" readonly>
                ...
                <div>
                    <label class="block text-sm font-semibold " for="explain"> <span id="requiredfild" style="color:red; display:none;">*</span>

                        توضیحات</label>
                    <textarea type="text" id="explain" name="explain" class="w-full border  border-gray-300 p-1 rounded" placeholder="توضیحات را وارد کنید"></textarea>
                </div>
                ...
                <div class="mt-4">
                    <button type="submit" class="bg-green-500 text-white px-4 py-2 rounded">ثبت ارسال</button>
                </div>
...
<el-dialog>
    <dialog id="dialog" aria-labelledby="dialog-title" class="fixed inset-0 size-auto max-h-none max-w-none overflow-y-auto bg-transparent backdrop:bg-transparent hidden">
        ...
        <div tabindex="0" class="flex min-h-full items-end justify-center p-4 text-center focus:outline-none sm:items-center sm:p-0">
            <el-dialog-panel class="relative transform overflow-hidden rounded-lg bg-white text-left transition-all data-closed:translate-y-4 data-closed:opacity-0 data-enter:duration-300 data-enter:ease-out data-leave:duration-200 data-leave:ease-in data-closed:sm:translate-y-0 data-closed:sm:scale-95">
                <div class="bg-white  sm:p-6 sm:pb-2">

                    <button type="button" command="close" onclick="closeDelivery();" commandfor="dialog" class="hide_while_print">
