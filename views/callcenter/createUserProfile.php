...
<div>
    ...
    <div class=" bg-gray-200 shadow-md w-1/2 mx-auto overflow-hidden">
        ...
        <div class="flex items-center justify-between p-5 bg-gray-800">
            ...
            <a href="./usersManagement.php" class="bg-gray-100   py-2 px-3 rounded-lg text-sm"> مدیریت کاربران
            </a>
        </div>
            ...
            <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="name" class="border-2 mt-1 block w-full border-gray-300 shadow-sm px-3 py-2 rounded" id="serial" type="text" />
                        <p class="mt-2"></p>
                    </div>
                    <!-- Price -->
                    <div class="mb-3">
                        ...
                        <input name="family" class="border-2 mt-1 block w-full border-gray-300 shadow-sm px-3 py-2 rounded" id="price" type="text" />
                        <p class="mt-2"> </p>
                    </div>
                    <!-- Weight -->
                    <div class="mb-3">
                        ...
                        <input style="direction: ltr !important;" required name="username" class="border-2 mt-1 block w-full border-gray-300 shadow-sm px-3 py-2 rounded" id="weight" type="text" />
                    ...
                    <div class="mb-3">
                        ...
                        <input name="profile" class="border-2 mt-1 text-sm block w-full bg-white border-gray-300 shadow-sm px-3 py-2 rounded" id="profile" type="file" />
                    </div>
                    <!-- Mobis -->
                    <div class="mb-3 relative">
                        ...
                        <input style="direction: ltr !important;" required name="password" minlength="5" maxlength="50" class="border-2 mt-1 block w-full border-gray-300 shadow-sm px-3 py-2 rounded" id="mobis" type="password" />
                    </div>
                    <!-- Korea section -->
                    <div class="mb-3">
                        <label class="block font-medium text-sm text-gray-700">
                    ...
                    <div class="flex justify-between items-center">
                        <button class="text-sm bg-green-700 text-white py-2 px-3 hover:bg-green-600 rounded" type="submit">ایجاد حساب کاربری</button>
                        <?= $success ? '<p class="bg-green-600 text-white px-5 py-2 rounded-md text-sm font-semibold">حساب کاربری با موفقیت ایجاد شد</p>' : ''; ?>
                    </div>
                </div>
            </form>
        </div>
