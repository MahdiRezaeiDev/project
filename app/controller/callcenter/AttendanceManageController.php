...
function getUsers()
{
    $users_sql = "SELECT users.id, name, family, settings.start_hour, settings.end_hour, settings.is_active , settings.end_week, settings.max_late_minutes, settings.user_id AS selectedUser
